...
//	@Override public void enterPassExpression(bugsParser.PassExpressionContext ctx) { }

    // TODO do sth about this passExpression, this is not right
	@Override public void exitPassExpression(bugsParser.PassExpressionContext ctx) {
        outputForNode.put(ctx, ctx.getText());
    }

    @Override public void exitParenExpression(bugsParser.ParenExpressionContext ctx) {
        outputForNode.put(ctx, outputForNode.get(ctx.expression()));
    }
...
//	@Override public void enterDistribution(bugsParser.DistributionContext ctx) { }
	...
	@Override public void exitDistribution(bugsParser.DistributionContext ctx) {
        ...
        switch (distributionName) {
            case "dnorm": FOPPLDistributionName = "normal"; break;
...
//    @Override public void enterFunction(bugsParser.FunctionContext ctx) { }

    @Override public void exitFunction(bugsParser.FunctionContext ctx) {
        String funcionName = ctx.ID().getText();
        String FOPPLFunctionName = "";
